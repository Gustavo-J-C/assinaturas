...
function generatePDF($formData) {
    ...
    $pdf->SetXY(75, 87);
    $pdf->Write(8, iconv('UTF-8', 'ISO-8859-1//TRANSLIT', $formData['endereco'] . ',  Bairro: ' . $formData['bairro']));
    $pdf->SetXY(23, 96);
    $pdf->Write(8, iconv('UTF-8', 'ISO-8859-1//TRANSLIT', ' Cidade: ' . $formData['cidade'] . ',   Cep: ' . $formData['CEP']));
    $pdf->SetXY(43, 108);
    $pdf->Write(4, iconv('UTF-8', 'ISO-8859-1//TRANSLIT', $formData['contato'] ));
    $pdf->SetXY(40, 188);
    $pdf->Write(8, iconv('UTF-8', 'ISO-8859-1//TRANSLIT', 'Salvador - BA   --   ' . date("d/m/Y")));
